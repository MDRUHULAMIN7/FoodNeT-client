...
const Team = () => {
    return (
        <section id="team" className="py-6 dark:bg-gray-100 dark:text-gray-800">
        <div className="container p-4 mx-auto space-y-16 xl:p-10">
            <div className="space-y-4">
                <h3 className="text-2xl font-bold leading-none xl:text-5xl">Meet our team</h3>
                <p className="max-w-2xl dark:text-gray-600">At FoodNet we all teammember work together,and always welp help each other friendly and try to our best as team</p>
            </div>
